...
namespace Gastao_B2.Controllers
{
    ...
    public class ATbUsersController : ControllerBase
    {
        ...
        [EnableCors("AllowAll")]
        [HttpGet("{id}")]
        public async Task<ActionResult<ATbUser>> GetATbUser(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutATbUser(int id, ATbUser aTbUser)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteATbUser(int id)
        {
            var aTbUser = await _context.ATbUsers.FindAsync(id);
            if (aTbUser == null)
            {
        ...
        private bool ATbUserExists(int id)
        {
