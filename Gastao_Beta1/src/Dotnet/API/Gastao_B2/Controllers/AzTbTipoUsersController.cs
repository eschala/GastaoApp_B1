...
namespace Gastao_B2.Controllers
{
    ...
    public class AzTbTipoUsersController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAzTbTipoUser(ulong id, AzTbTipoUser azTbTipoUser)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteAzTbTipoUser(ulong id)
        {
        ...
        private bool AzTbTipoUserExists(ulong id)
        {
